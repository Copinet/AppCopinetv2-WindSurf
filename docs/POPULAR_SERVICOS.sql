-- =====================================================
-- SCRIPT PARA POPULAR SERVIÇOS NO BANCO DE DADOS
...
INSERT INTO servicos (categoria_id, nome, descricao, preco_base, preco_desconto, tempo_estimado, tipo_execucao, requer_dados_cliente, campos_formulario, ativo)
SELECT 
  id,
  'Certidão de Antecedentes Criminais',
...
SELECT 
  ...
  '[
    ...
    {"nome": "informacoes", "label": "Informações Relevantes", "tipo": "textarea", "obrigatorio": true, "ajuda": "Conte sobre sua experiência e porque quer a vaga"}
  ]'::jsonb,
  true
FROM categorias WHERE nome = 'Currículos e Cartas';
